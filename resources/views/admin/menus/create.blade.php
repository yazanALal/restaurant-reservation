...
<div class="py-10 h-screen">
    ...
    <div class="flex flex-col items-center justify-center ">
        ...
        <form enctype="multipart/form-data" method="POST" action="{{route('admin.menus.store')}}" class="space-y-6 bg-gray-800 p-8 rounded-lg shadow-lg " style="width: 500px;">
           @csrf
            <div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <textarea id="description" rows="3"  name="description" class="block w-full bg-gray-700 border-gray-500 focus:ring-indigo-500 focus:border-indigo-500 rounded-md shadow-sm py-2 px-3 text-sm text-gray-100"></textarea>
                    @error('description')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="text" id="price"  name="price" class="block w-full bg-gray-700 border-gray-500 focus:ring-indigo-500 focus:border-indigo-500 rounded-md shadow-sm py-2 px-3 text-sm text-gray-100" />
                    @error('price')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                </div>
