...
<div class="py-12 h-screen">
    <div class="flex flex-col items-center justify-center ">
        ...
        <form  method="POST" action="{{route('admin.reservations.store')}}" class="space-y-6 bg-gray-800 p-8 rounded-lg shadow-lg" style="width: 500px;">
           @csrf
            <div>
                <label for="first_name" class="block  text-sm font-medium text-gray-300">First Name</label>
                <div class="mt-1">
                    <input type="text" id="first_name"  name="first_name" class="block w-full bg-gray-700 border-gray-500 focus:ring-indigo-500 focus:border-indigo-500 rounded-md shadow-sm py-2 px-3 text-sm text-gray-100" />
                    @error('first_name')
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="text" id="last_name"  name="last_name" class="block w-full bg-gray-700 border-gray-500 focus:ring-indigo-500 focus:border-indigo-500 rounded-md shadow-sm py-2 px-3 text-sm text-gray-100" />
                    @error('last_name')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="text" id="email"  name="email" class="block w-full bg-gray-700 border-gray-500 focus:ring-indigo-500 focus:border-indigo-500 rounded-md shadow-sm py-2 px-3 text-sm text-gray-100" />
                    @error('email')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="text" id="phone"  name="phone" class="block w-full bg-gray-700 border-gray-500 focus:ring-indigo-500 focus:border-indigo-500 rounded-md shadow-sm py-2 px-3 text-sm text-gray-100" />
                    @error('phone')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="datetime-local" id="res_date"  name="res_date" class="block w-full bg-gray-700 border-gray-500 focus:ring-indigo-500 focus:border-indigo-500 rounded-md shadow-sm py-2 px-3 text-sm text-gray-100" />
                    @error('res_date')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div>
                ...
                <div class="mt-1"> 
                    <select id="table_id"  name="table_id" class="block w-full bg-gray-700 border-gray-500 focus:ring-indigo-500 focus:border-indigo-500 rounded-md shadow-sm py-2 px-3 text-sm text-gray-100">
                        ...
                        @if (count($tables) == 0)
                            <option disabled selected>Sorry all Tables are busy</option>    
                        @else
